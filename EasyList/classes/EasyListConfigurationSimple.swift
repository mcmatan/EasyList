...
public class EasyListConfigurationSimple: EasyListConfigurationType {
    ...
    public var dataSourceAndDelegate: UITableViewDelegate & UITableViewDataSource {
        get {
    ...
    public class EasyListConfigurationSimpleDelegateProvider: UITableViewDelegate, UITableViewDataSource {
